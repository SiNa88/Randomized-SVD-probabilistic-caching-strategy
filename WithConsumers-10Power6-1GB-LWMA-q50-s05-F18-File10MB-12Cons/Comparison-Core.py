...
def CS():
	m1_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-1.csv", delimiter=',')
	X1_HomoHit=np.matrix(m1_HomoHit)
	m2_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-2.csv", delimiter=',')
	X2_HomoHit=np.matrix(m2_HomoHit)
	m3_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-3.csv", delimiter=',')
	X3_HomoHit=np.matrix(m3_HomoHit)
	m4_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-4.csv", delimiter=',')
	X4_HomoHit=np.matrix(m4_HomoHit)
	m5_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-5.csv", delimiter=',')
	X5_HomoHit=np.matrix(m5_HomoHit)
	m6_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-6.csv", delimiter=',')
	X6_HomoHit=np.matrix(m6_HomoHit)
	m7_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-7.csv", delimiter=',')
	X7_HomoHit=np.matrix(m7_HomoHit)
	m8_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-8.csv", delimiter=',')
	X8_HomoHit=np.matrix(m8_HomoHit)
	m9_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-9.csv", delimiter=',')
	X9_HomoHit=np.matrix(m9_HomoHit)
	m10_HomoHit = np.loadtxt("Homo/Hit-Core-Homo-10.csv", delimiter=',')
	X10_HomoHit=np.matrix(m10_HomoHit)
	
	m_mean_HomoHit = np.zeros((11,500))	
	
	m1_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-1.csv", delimiter=',')
	X1_HomoHitMiss=np.matrix(m1_HomoHitMiss)
	m2_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-2.csv", delimiter=',')
	X2_HomoHitMiss=np.matrix(m2_HomoHitMiss)
	m3_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-3.csv", delimiter=',')
	X3_HomoHitMiss=np.matrix(m3_HomoHitMiss)
	m4_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-4.csv", delimiter=',')
	X4_HomoHitMiss=np.matrix(m4_HomoHitMiss)
	m5_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-5.csv", delimiter=',')
	X5_HomoHitMiss=np.matrix(m5_HomoHitMiss)
	m6_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-6.csv", delimiter=',')
	X6_HomoHitMiss=np.matrix(m6_HomoHitMiss)
	m7_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-7.csv", delimiter=',')
	X7_HomoHitMiss=np.matrix(m7_HomoHitMiss)
	m8_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-8.csv", delimiter=',')
	X8_HomoHitMiss=np.matrix(m8_HomoHitMiss)
	m9_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-9.csv", delimiter=',')
	X9_HomoHitMiss=np.matrix(m9_HomoHitMiss)
	m10_HomoHitMiss = np.loadtxt("Homo/HitMiss-Core-Homo-10.csv", delimiter=',')
	...
	plt.plot(x,Smooth_Homo,'-g',label="Betweenness",lw=6,ms=5)
	plt.plot(x,Smooth_NonHomo,'-r',label="ProposedMethod",lw=6,ms=5)
	plt.legend(loc='upper right')
	plt.title('Number of Hit Interests in NDN Routers')
	plt.xlim([1,tedaad])
	plt.ylim([0.00,1.4])
	...
	#print x
	#print x3
	#plt.errorbar(x,Smooth_Homo/Smooth_Homo_HitMiss,yerr=0.4)# width=0.2, color='green',
	...
	plt.legend(loc='upper right')
	plt.title('Average Hit Ratio of NDN Routers')
	plt.xlim([1,tedaad])
	plt.ylim([0.00,0.4])
	#plt.xlabel('Simulation Time (*100 Seconds)')
	plt.ylabel('HitRatio')
