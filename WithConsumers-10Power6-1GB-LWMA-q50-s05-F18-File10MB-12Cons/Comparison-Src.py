...
def CS():
	m1_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-1.csv", delimiter=',')
	X1_HomoHit=np.matrix(m1_HomoHit)
	m2_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-2.csv", delimiter=',')
	X2_HomoHit=np.matrix(m2_HomoHit)
	m3_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-3.csv", delimiter=',')
	X3_HomoHit=np.matrix(m3_HomoHit)
	m4_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-4.csv", delimiter=',')
	X4_HomoHit=np.matrix(m4_HomoHit)
	m5_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-5.csv", delimiter=',')
	X5_HomoHit=np.matrix(m5_HomoHit)
	m6_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-6.csv", delimiter=',')
	X6_HomoHit=np.matrix(m6_HomoHit)
	m7_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-7.csv", delimiter=',')
	X7_HomoHit=np.matrix(m7_HomoHit)
	m8_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-8.csv", delimiter=',')
	X8_HomoHit=np.matrix(m8_HomoHit)
	m9_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-9.csv", delimiter=',')
	X9_HomoHit=np.matrix(m9_HomoHit)
	m10_HomoHit = np.loadtxt("Homo/Hit-Src-Homo-10.csv", delimiter=',')
	X10_HomoHit=np.matrix(m10_HomoHit)
	
	m_mean_HomoHit = np.zeros((4,500))	
	
	m1_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-1.csv", delimiter=',')
	X1_HomoHitMiss=np.matrix(m1_HomoHitMiss)
	m2_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-2.csv", delimiter=',')
	X2_HomoHitMiss=np.matrix(m2_HomoHitMiss)
	m3_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-3.csv", delimiter=',')
	X3_HomoHitMiss=np.matrix(m3_HomoHitMiss)
	m4_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-4.csv", delimiter=',')
	X4_HomoHitMiss=np.matrix(m4_HomoHitMiss)
	m5_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-5.csv", delimiter=',')
	X5_HomoHitMiss=np.matrix(m5_HomoHitMiss)
	m6_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-6.csv", delimiter=',')
	X6_HomoHitMiss=np.matrix(m6_HomoHitMiss)
	m7_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-7.csv", delimiter=',')
	X7_HomoHitMiss=np.matrix(m7_HomoHitMiss)
	m8_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-8.csv", delimiter=',')
	X8_HomoHitMiss=np.matrix(m8_HomoHitMiss)
	m9_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-9.csv", delimiter=',')
	X9_HomoHitMiss=np.matrix(m9_HomoHitMiss)
	m10_HomoHitMiss = np.loadtxt("Homo/HitMiss-Src-Homo-10.csv", delimiter=',')
	...
	plt.title('Average Hit Ratio of Producers')
	plt.xlim([1,tedaad])
	plt.ylim([0.00,0.005])
