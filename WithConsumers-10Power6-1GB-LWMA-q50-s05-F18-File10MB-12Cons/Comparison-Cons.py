...
def CS():
	m1_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-1.csv", delimiter=',')
	X1_HomoHit=np.matrix(m1_HomoHit)
	m2_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-2.csv", delimiter=',')
	X2_HomoHit=np.matrix(m2_HomoHit)
	m3_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-3.csv", delimiter=',')
	X3_HomoHit=np.matrix(m3_HomoHit)
	m4_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-4.csv", delimiter=',')
	X4_HomoHit=np.matrix(m4_HomoHit)
	m5_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-5.csv", delimiter=',')
	X5_HomoHit=np.matrix(m5_HomoHit)
	m6_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-6.csv", delimiter=',')
	X6_HomoHit=np.matrix(m6_HomoHit)
	m7_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-7.csv", delimiter=',')
	X7_HomoHit=np.matrix(m7_HomoHit)
	m8_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-8.csv", delimiter=',')
	X8_HomoHit=np.matrix(m8_HomoHit)
	m9_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-9.csv", delimiter=',')
	X9_HomoHit=np.matrix(m9_HomoHit)
	m10_HomoHit = np.loadtxt("Homo/Hit-Cons-Homo-10.csv", delimiter=',')
	X10_HomoHit=np.matrix(m10_HomoHit)
	
	m_mean_HomoHit = np.zeros((12,500))	
	
	m1_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-1.csv", delimiter=',')
	X1_HomoHitMiss=np.matrix(m1_HomoHitMiss)
	m2_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-2.csv", delimiter=',')
	X2_HomoHitMiss=np.matrix(m2_HomoHitMiss)
	m3_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-3.csv", delimiter=',')
	X3_HomoHitMiss=np.matrix(m3_HomoHitMiss)
	m4_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-4.csv", delimiter=',')
	X4_HomoHitMiss=np.matrix(m4_HomoHitMiss)
	m5_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-5.csv", delimiter=',')
	X5_HomoHitMiss=np.matrix(m5_HomoHitMiss)
	m6_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-6.csv", delimiter=',')
	X6_HomoHitMiss=np.matrix(m6_HomoHitMiss)
	m7_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-7.csv", delimiter=',')
	X7_HomoHitMiss=np.matrix(m7_HomoHitMiss)
	m8_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-8.csv", delimiter=',')
	X8_HomoHitMiss=np.matrix(m8_HomoHitMiss)
	m9_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-9.csv", delimiter=',')
	X9_HomoHitMiss=np.matrix(m9_HomoHitMiss)
	m10_HomoHitMiss = np.loadtxt("Homo/HitMiss-Cons-Homo-10.csv", delimiter=',')
	X10_HomoHitMiss=np.matrix(m10_HomoHitMiss)
	
	m_mean_HomoHitMiss = np.zeros((12,500))
	HitRateHomo=np.zeros((12,500))

	m1_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-1.csv", delimiter=',')
	X1_NonHomoHit=np.matrix(m1_NonHomoHit)
	m2_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-2.csv", delimiter=',')
	X2_NonHomoHit=np.matrix(m2_NonHomoHit)
	m3_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-3.csv", delimiter=',')
	X3_NonHomoHit=np.matrix(m3_NonHomoHit)
	m4_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-4.csv", delimiter=',')
	X4_NonHomoHit=np.matrix(m4_NonHomoHit)
	m5_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-5.csv", delimiter=',')
	X5_NonHomoHit=np.matrix(m5_NonHomoHit)
	m6_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-6.csv", delimiter=',')
	X6_NonHomoHit=np.matrix(m6_NonHomoHit)
	m7_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-7.csv", delimiter=',')
	X7_NonHomoHit=np.matrix(m7_NonHomoHit)
	m8_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-8.csv", delimiter=',')
	X8_NonHomoHit=np.matrix(m8_NonHomoHit)
	m9_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-9.csv", delimiter=',')
	X9_NonHomoHit=np.matrix(m9_NonHomoHit)
	m10_NonHomoHit = np.loadtxt("NonHomo/Hit-Cons-NonHomo-10.csv", delimiter=',')
	X10_NonHomoHit=np.matrix(m10_NonHomoHit)
	
	m_mean_NonHomoHit = np.zeros((12,500))	

	m1_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-1.csv", delimiter=',')
	X1_NonHomoHitMiss=np.matrix(m1_NonHomoHitMiss)
	m2_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-2.csv", delimiter=',')
	X2_NonHomoHitMiss=np.matrix(m2_NonHomoHitMiss)
	m3_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-3.csv", delimiter=',')
	X3_NonHomoHitMiss=np.matrix(m3_NonHomoHitMiss)
	m4_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-4.csv", delimiter=',')
	X4_NonHomoHitMiss=np.matrix(m4_NonHomoHitMiss)
	m5_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-5.csv", delimiter=',')
	X5_NonHomoHitMiss=np.matrix(m5_NonHomoHitMiss)
	m6_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-6.csv", delimiter=',')
	X6_NonHomoHitMiss=np.matrix(m6_NonHomoHitMiss)
	m7_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-7.csv", delimiter=',')
	X7_NonHomoHitMiss=np.matrix(m7_NonHomoHitMiss)
	m8_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-8.csv", delimiter=',')
	X8_NonHomoHitMiss=np.matrix(m8_NonHomoHitMiss)
	m9_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-9.csv", delimiter=',')
	X9_NonHomoHitMiss=np.matrix(m9_NonHomoHitMiss)
	m10_NonHomoHitMiss = np.loadtxt("NonHomo/HitMiss-Cons-NonHomo-10.csv", delimiter=',')
	X10_NonHomoHitMiss=np.matrix(m10_NonHomoHitMiss)

	m_mean_NonHomoHitMiss = np.zeros((12,500))
	HitRateNonHomo=np.zeros((12,500))
	...
	#plt.plot(x,Smooth_Homo/Smooth_Homo_HitMiss,'-c',label="Ubiquitous",lw=6,ms=5)
	...
	print x
	print x3
	plt.bar(x,Smooth_Homo/Smooth_Homo_HitMiss, width=0.2, color='green')#,align='center')
	plt.bar(x3,Smooth_NonHomo/Smooth_NonHomo_HitMiss, width=0.2, color='red')#, align='center')'''
	plt.plot(x,Smooth_Homo_HitRate,'-g',label="Betweenness",lw=6,ms=5)
	plt.plot(x,Smooth_NonHomo_HitRate,'-r',label="ProposedMethod",lw=6,ms=5)


	plt.legend(loc='upper right')
	plt.title('Average Hit Ratio of Consumers')
	plt.xlim([0.9,tedaad+0.1])
	plt.ylim([0.00,1.1])
